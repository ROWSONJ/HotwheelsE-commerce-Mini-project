      ...
      <div class="container">
        ...
        <div class="footer-middle section">
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="tel:+557343673257" class="footer-link">
                ...
                <span class="footer-link-text">+664561289</span>
              </a>
            </li>
            ...
            <li>
              <a href="mailto:footcap@help.com" class="footer-link">
                ...
                <span class="footer-link-text">fastlanethailand@gmail.com</span>
              </a>
            </li>
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="404.php" class="footer-link">
                <ion-icon name="chevron-forward-outline"></ion-icon>

                <span class="footer-link-text">Customer Service</span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="footer-link">
                ...
                <span class="footer-link-text">Shipping Rates & Policy</span>
              </a>
            </li>
          </ul>
            ...
            <li>
              <a href="#" class="footer-link">
                ...
                <span class="footer-link-text">Legal</span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="footer-link">
                ...
                <span class="footer-link-text">Terms of Sale</span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="footer-link">
                ...
                <span class="footer-link-text">Privacy Statement</span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="footer-link">
                ...
                <span class="footer-link-text">Cookies & Technology</span>
              </a>
            </li>
